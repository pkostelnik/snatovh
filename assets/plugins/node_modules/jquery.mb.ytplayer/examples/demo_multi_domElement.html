<!--::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  file: demo_multi_domElement.html
...
<head>
    ...
    <script>
        var myPlayer;
        $(function () {
            myPlayer = $('.video').YTPlayer({playOnlyIfVisible: true});
        });
    </script>
</head>
<body>
<div id="wrapper">
    ...
    <div id="container-1" class="video" data-property="{videoURL:'59Rkw_Lg-0U',containment:'self',autoPlay:true, mute:true, startAt:0, opacity:1}"></div>
    <div class="gap"></div>
    <div id="container-2" class="video" data-property="{videoURL:'59Rkw_Lg-0U',containment:'self',autoPlay:true, mute:true, startAt:5, opacity:1}"></div>
    <div class="gap"></div>
    <div id="container-3" class="video" data-property="{videoURL:'u9k1FaMIYTs',containment:'self',autoPlay:true, mute:true, startAt:5, opacity:1}"></div>
