...
<head>
    ...
    <script>
        ...
        var videos = ["VuaJAgx0x_4", "59Rkw_Lg-0U", "u9k1FaMIYTs", "bkCg84XgBUg", "59Rkw_Lg-0U"];
        //Define the random video to be passed to the initialization call
...
<div id="wrapper">
    ...
    <h2>Random video from a list.</h2>
    <h2>Each time you reload the page a video is randomly selected.</h2>
</div>
