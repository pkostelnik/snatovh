...
<head>
    ...
    <script>
		...
		jQuery(function () {
			...
			myPlayListPlayer = jQuery("#P1").YTPlaylist(videos, false, function (video) {
                /*
                 if (video.videoData) {
...
<div id="wrapper">
    ...
    <div class="player-container">
        <!-- , goFullScreenOnPlay:true -->
        <div id="P1" class="player" style="display:block; background: rgba(0,0,0,0.5); overflow: hidden"></div>
        <!--59Rkw_Lg-0U-->
    </div>
    <br>
    <div class="controls">
        <button onclick="jQuery('#P1').YTPPlayPrev()">prev video</button>
        <button onclick="jQuery('#P1').YTPPlayNext()">next video</button>
        &nbsp;&nbsp;&nbsp;
        ...
        <br>
        <br>
        <input name="toggleFullScreenOnPlay" id="toggleFullScreenOnPlay" type="checkbox" onchange="toggleFullScreenOnPlay(this)" value="true"><label for="toggleFullScreenOnPlay">Activate Fullscreen on play</label>
    </div>
